namespace EstudoCS.Observers
{
    public class PessoaBuilder
    {
        ...
        private List<IAcaoAposCadastroPessoa> _acoesAposCadastroPessoa;

        public Pessoa Construir()
        {
            return new Pessoa(_nome, _dataNascimento, _cpf, _rg, _sexo, _apelido, _celular, _telefone, _email, _acoesAposCadastroPessoa);
        }
        ...
        public PessoaBuilder SetAcaoAposCadastroPessoa(IAcaoAposCadastroPessoa acaoAposCadastroPessoa)
        {
            if (_acoesAposCadastroPessoa ==null)
                _acoesAposCadastroPessoa = new List<IAcaoAposCadastroPessoa>();

            this._acoesAposCadastroPessoa.Add(acaoAposCadastroPessoa);
            return this;
        }
    }
}